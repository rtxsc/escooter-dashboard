# [eScooter Tracking Dashboard](https://startbootstrap.com/template-overviews/sb-admin-2/)
...
Copyright 2020 Clumsy Zidz LLC. Code released under the [MIT](https://github.com/BlackrockDigital/startbootstrap-resume/blob/gh-pages/LICENSE) license.
